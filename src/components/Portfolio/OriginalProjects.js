        ...
        <div className='row'>
          ...
          <div className='col-sm-6'>
            <div className='card text-bg-dark content_img'>
              <img src={Capstone} className='card-img' alt='Capstone'></img>
              <div className='card-img-overlay'>
                <h5 className='card-title'>Capstone</h5>
                <p className='card-text'>
                  This daily workout tracker will help you maintain your
                  physical health by adding workouts to your calendar and
